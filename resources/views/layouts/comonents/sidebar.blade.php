          ...
          <ul>
            ...
            <li class="submenu">
              <a href="{{ route('student.index') }}">
                <i class="fe fe-layout"></i> <span> Students </span> <span
            ...
            <li class="submenu">
              <a href="{{ route('books.index') }}"><i class="fe fe-layout"></i> <span> Books </span> <span class="menu-arrow"></span></a>
              <ul style="display: none;">
                <li><a href="{{ route('books.index') }}">All Books </a></li>
                <li><a href="{{ route('books.create') }}">Add New Books </a></li>
              </ul>
            </li>
